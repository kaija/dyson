...
#print get_hostname()
def compose_report(host="localhost", port=443, project="default"):
  data = {}
...
parser.add_option("-i", "--id", dest="id", default="default",
                  help="project id")

(options, args) = parser.parse_args()

if compose_report(host=options.host, port=options.port, project=options.id):
  print "OK"
else:
  print "CRITICAL"
